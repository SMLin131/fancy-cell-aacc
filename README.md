...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/fancy-cell-aacc#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fancy-cell-aacc
```

A live public deployment of this template is available at [https://fancy-cell-aacc.templates.workers.dev](https://fancy-cell-aacc.templates.workers.dev)
